[![CSDN](https://img.shields.io/badge/CSDN-@lemononly-blue.svg?style=flat)](http://blog.csdn.net/guolemononly)
[![PersonBlog](https://img.shields.io/badge/PersonBlog-@lemononly-blue.svg?style=flat)](http://lemononly.cn/)

# 实现如下
![image](https://github.com/lemononly/Ticket-Analysis/blob/master/operate.gif)
...
n个全是正选号码：![image](https://github.com/lemononly/Ticket-Analysis/blob/master/7.png)

n个正选加一个特别号码：![image](https://github.com/lemononly/Ticket-Analysis/blob/master/6%2B1.png) - ![image](https://github.com/lemononly/Ticket-Analysis/blob/master/7.png)
