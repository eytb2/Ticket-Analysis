 ...
 */
public class TitleBarUtil extends ViewGroup implements View.OnClickListener {
    ...
    public TitleBarUtil(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public TitleBarUtil(Context context, AttributeSet attrs, int defStyleAttr) {
