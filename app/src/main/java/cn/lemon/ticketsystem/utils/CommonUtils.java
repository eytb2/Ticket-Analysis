package cn.lemon.ticketsystem.utils;
...
public class CommonUtils {
    ...
    public static void copyProperties(cn.lemon.ticketsystem.model.ItemModel desc, cn.lemon.ticketsystem.model.ItemModel orign) {
        if ( orign != null ) {
     ...
     * @param item
     */
    public static void setData(int currIndex, cn.lemon.ticketsystem.model.ItemModel itemModel, String item) {
        switch ( currIndex ) {
            case 1:
     ...
     * @param list
     */
    public static void resetData(List<cn.lemon.ticketsystem.model.ItemModel> list) {
        List<String> l = null;
        for ( cn.lemon.ticketsystem.model.ItemModel item :
                list ) {
            l = new ArrayList<>();
            l.add(item.getNo1());
            l.add(item.getNo2());
