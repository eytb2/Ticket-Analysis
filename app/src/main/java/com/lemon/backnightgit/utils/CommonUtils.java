...
public class CommonUtils {
    ...
    public static void copyProperties(com.lemon.backnightgit.model.ItemModel desc, com.lemon.backnightgit.model.ItemModel orign) {
        if ( orign != null ) {
     ...
     * @param item
     */
    public static void setData(int currIndex, com.lemon.backnightgit.model.ItemModel itemModel, String item) {
        switch ( currIndex ) {
            case 1:
     ...
     * @param list
     */
    public static void resetData(List<com.lemon.backnightgit.model.ItemModel> list) {
        List<String> l = null;
        for ( com.lemon.backnightgit.model.ItemModel item :
                list ) {
            l = new ArrayList<>();
            l.add(item.getNo1());
            l.add(item.getNo2());
