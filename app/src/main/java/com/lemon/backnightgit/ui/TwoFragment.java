...
import com.lemon.backnightgit.ui.pullableview.PullableListView;
...
//            viewHolder.mIcon.setImageURI(newsData.getIconUrl());
            Glide.with(getActivity()).load(newsData.getIconUrl()).into(viewHolder.mIcon);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRefreshLayout= (PullToRefreshLayout) mView.findViewById(R.id.refreshLayout);
        mNewsList= (PullableListView) mView.findViewById(R.id.newsList);
